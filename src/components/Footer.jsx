      ...
      >
        ...
        <div className="flex flex-col gap-10 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap gap-6 text-sm text-white">
            <button
              onClick={() => handleScrollTo("includes-section")}
        ...
        <div className="mt-6 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <p className="max-w-md text-[12px] text-slate-300 leading-relaxed">
            Este contenido no reemplaza procesos terapéuticos ni asesoría profesional.  
            Es una herramienta de reflexión y crecimiento personal para acompañar tu proceso interno.
          </p>
          ...
          <div className="flex items-center gap-4 text-sm text-white">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.6">
